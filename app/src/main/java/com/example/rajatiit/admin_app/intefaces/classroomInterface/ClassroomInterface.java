...
public class ClassroomInterface extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        customCourseListAdapter = new CustomCourseListAdapter(getBaseContext(),R.layout.activity_display_data_interface,institute.getClassrooms());
