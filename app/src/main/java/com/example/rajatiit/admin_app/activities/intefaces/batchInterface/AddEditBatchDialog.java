package com.example.rajatiit.admin_app.activities.intefaces.batchInterface;
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        showPassword.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                EditText editText = (EditText) view.findViewById(R.id.add_edit_batch_password);
                if (isChecked){
            ...
            public void onClick(View v) {
                if (handleErrors()) {
                    ...
                    if (isEditView){
                        getDetails();
                        dismiss();
                        batchDetail.setUserName(batchDetail.getYear()+batchDetail.getDepartmentName());
